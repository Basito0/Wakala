                            ...
                            GestureDetector(
                              onTap: () async {
                                if (commentController.text.isNotEmpty) {
                                  ...
                                  await addCommentToPost(sharedPrefs.getLink(),
                                      snapshot.data!['id'], commentData);
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => PostDetails()),
                            ...
                            children: [
                              GestureDetector(
                                  onTap: () async {
                                    ...
                                    editarContadores(sharedPrefs.getLink(),
                                        snapshot.data!['id'], contadores);
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => PostDetails()),
                                  ...
                                  child: Container(
                                      ...
                                      padding: const EdgeInsets.symmetric(
                                          vertical: 15.0, horizontal: 30.0),
                                      child: Text(
                                          "Sigue ahí (${snapshot.data!["sige_ahi_count"]})"))),
                              GestureDetector(
                                  onTap: () async {
                                    Map<String, dynamic> contadores = {
                                      "sigue_ahi": 0,
                                  ...
                                  child: Container(
                                      ...
                                      padding: const EdgeInsets.symmetric(
                                          vertical: 15.0, horizontal: 30.0),
                                      child: Text(
                                          "Sigue ahí (${snapshot.data!["ya_no_esta_count"]})"))),
                            ],
                          ),
                          ListView.builder(
                            shrinkWrap: true,
                              ...
                              return Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Text(
                                        snapshot.data!['comentarios'][index]
                                                ['comentario'] +
                                            "\n@" +
                                            snapshot.data!['comentarios'][index]
                                                ['username'],
              ...
              return Padding(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 10),
                        const Text(
                            "¿Problemas de conexión? ¿Mensajes de error?"),
                        ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ConexionErrorScreen()),
                            );
                          },
                          style: ButtonStyle(
                            fixedSize: MaterialStateProperty.all<Size>(
                  ...
                  if (!esCorreo(emailController.text)) {
                    ...
                    for (int i = 0; i < userList!.length; i++) {
                      if ((userList![i]['username'] ==
                        ...
                        Fluttertoast.showToast(
                          msg:
                              "Ese nombre de usuario ya está en uso. Prueba uno distinto",
                          toastLength: Toast.LENGTH_SHORT,
                          gravity: ToastGravity.BOTTOM,
                          backgroundColor: Colors.red,
                          textColor: Colors.white,
    ...
    return Scaffold(
        ...
        body: Padding(
            ...
            child: Column(
              children: [
                const Text(
                    "Los problemas de conexión pueden deberse a que la URL que utiliza la API haya cambiado. Si es así, por favor enviar un correo a reiturra2021@udec.cl y responderé a la brevedad con la nueva URL.\n Una vez obtenida, copiar y pegar la nueva URL en el campo de abajo."),
                const SizedBox(height: 20),
                TextField(
                  controller: urlController,
                  decoration: const InputDecoration(
                      labelText: 'Nueva URL', border: OutlineInputBorder()),
                ),
                const SizedBox(height: 20),
                ElevatedButton(
                  onPressed: () {
